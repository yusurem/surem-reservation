  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View style={{width:'90%',height:'28%',backgroundColor:'#4284E4',borderRadius:10,alignSelf:'center'}}>
        <Text style={{color:'white',marginLeft:'3%',fontSize:15, marginTop: '8%'}}>MY 예약내역</Text>
        <View style={{height:'5%'}}/>
        ...
        <Text></Text>
        <View style={{width:'90%',height:150,backgroundColor:'#ECEFF4',borderRadius:10,alignSelf:'center', borderColor}}>
          <View style={{height:'8%'}}/>
